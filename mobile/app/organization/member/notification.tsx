...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Your tree 'Mango' has been successfully planted and recorded.",
  ...
  {
    id: 3,
    title: "Monitoring Assigned",
    message: "You have been assigned to monitor Activity #123.",
  ...
  },
  {
    ...
    message: "Your certificate for the recent planting activity is now available.",
  ...
  },
  {
    ...
    message: "Your request to join Green Earth Organization has been accepted.",
    type: "join_accepted",
    is_read: true,
